function [g] = G(Ap, t, k, lambda, Uc) 
%G - One line description of what the function or script performs (H1 line) 
%Optional file header info (to give more details about the function than in the H1 line) 
%Optional file header info (to give more details about the function than in the H1 line) 
%Optional file header info (to give more details about the function than in the H1 line) 
% 
% Syntax:  [output1,output2] = G(input1,input2,input3) 
% 
% Inputs: 
%    input1 - Description 
%    input2 - Description 
...
g = integral(@(x)F(x, t, k, lambda, Uc), 0, Ap);
